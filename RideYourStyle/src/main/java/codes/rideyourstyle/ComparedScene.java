    ...
    static class XCell1 extends ListCell<String> {
        ...
        protected void updateItem(String item, boolean empty) {
            ...
            if (empty) {
                ...
                String[] ar1 = {car1.name,car1.transmissionType,car1.fuelType,car1.bodyType,car1.wheelSize,car1.convertible,car1.price,car1.stock,car1.doors
                        ,car2.name, car2.transmissionType,car2.fuelType,car2.bodyType,car2.wheelSize,car2.convertible,car2.price,car2.stock,car2.doors};
                for (String s : ar1) {
                    if (lastItem.equals(s)) {
                    arrow1.setVisible(false);
                    }
                }
                String[] ar2 = {car1.engine,car1.enginePower,car1.topSpeed,car1.acceleration,car1.mileage,car1.fuelCapacity,car1.seatingCapacity,car1.rating};
                String[] ar3 = {car2.engine,car2.enginePower,car2.topSpeed,car2.acceleration,car2.mileage,car2.fuelCapacity,car2.seatingCapacity,car2.rating};
